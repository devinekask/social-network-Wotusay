...
const p1 = new Picture({pic:'./assets/img/foto.png' , store: store.dataStore});
p1.comments = [
...
const p2 = new Picture({pic:'./assets/img/switch.jpg', pictureLikes: 10, store: store.dataStore });
p2.comments = [
